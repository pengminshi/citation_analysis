...
# input a list include 1.year; 2.cirperyear; 3.paper title(if plot = T)
...
#' fit RPP model
#' 
#' fit Reinforced poisson process model(RPP) proposed in the science paper, by maximize log likelihood function
#' 
...
#' @param m (optional) the global constant, suggested m = 30 by the science paper, as the defalt.
...
# alpha, beta are the prior of lambda defined in the paper (Huawei Shen, etc 2014), which is an extension of original model.
...
# given the parameters of the citation science model
